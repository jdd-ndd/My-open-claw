...
- [1. 变更记录说明](#1-变更记录说明)
  ...
  - [1.3 记录规范](#13-记录规范)
- [2. 变更记录表](#2-变更记录表)
  - [2.1 v1.1.3（2026-08-12）CI 绿 + lint 清理](#213-v1132026-08-12ci-绿--lint-清理)
  - [2.2 v1.1.1（2026-07-24）Channels 渠道模块正式实现](#22-v1112026-07-24channels-渠道模块正式实现)
  - [2.3 v1.0.2（2026-07-23）文档同步代码实际状态](#23-v1022026-07-23文档同步代码实际状态)
  - [2.4 v1.1.0（2026-07-21）客户端层新增](#24-v1102026-07-21客户端层新增)
- [2.5 v1.0.0（2026-07-21）首次正式发布](#25-v1002026-07-21首次正式发布)
- [2.6 v0.9.0（2026-07-14）Beta 发布](#26-v0902026-07-14-beta-发布)
...
### 2.1 v1.1.3（2026-08-12）CI 绿 + lint 清理
...
### 2.2 v1.1.1（2026-07-24）Channels 渠道模块正式实现
