...
- [1. 变更记录说明](#1-变更记录说明)
  ...
  - [1.3 记录规范](#13-记录规范)
- [2. 变更记录表](#2-变更记录表)
  - [2.1 v1.2.3（2026-08-14）MessageList Tests](#21-v1232026-08-14messagelist-tests)
  - [2.2 v1.2.2（2026-08-14）MessageBubble Content Block Coverage](#22-v1222026-08-14messagebubble-content-block-coverage)
  - [2.3 v1.2.1（2026-08-14）ModelPicker Real-Component Tests](#23-v1212026-08-14modelpicker-real-component-tests)
  - [2.4 v1.2.0（2026-08-14）Web Component Test Expansion](#24-v1202026-08-14web-component-test-expansion)
  - [2.5 v1.1.9（2026-08-14）Release Engineering & Web Component Tests](#25-v1192026-08-14release-engineering--web-component-tests)
  - [2.6 v1.1.8（2026-08-13）CLI Memory Management](#26-v1182026-08-13cli-memory-management)
  - [2.7 v1.1.7（2026-08-13）Web Memory Management UI](#27-v1172026-08-13web-memory-management-ui)
  - [2.8 v1.1.6（2026-08-13）Memory API & Release Engineering](#28-v1162026-08-13memory-api--release-engineering)
  - [2.9 v1.1.5（2026-08-13）Memory Test Coverage & Doctor JSON](#29-v1152026-08-13memory-test-coverage--doctor-json)
  - [2.10 v1.1.4（2026-08-13）System Overview & Diagnostics](#210-v1142026-08-13system-overview--diagnostics)
  - [2.11 v1.1.3（2026-08-12）CI 绿 + lint 清理](#211-v1132026-08-12ci-绿--lint-清理)
  - [2.12 v1.1.1（2026-07-24）Channels 渠道模块正式实现](#212-v1112026-07-24channels-渠道模块正式实现)
  - [2.13 v1.0.2（2026-07-23）文档同步代码实际状态](#213-v1022026-07-23文档同步代码实际状态)
  - [2.14 v1.1.0（2026-07-21）客户端层新增](#214-v1102026-07-21客户端层新增)
  - [2.15 v1.0.0（2026-07-21）首次正式发布](#215-v1002026-07-21首次正式发布)
  - [2.16 v0.9.0（2026-07-14）Beta 发布](#216-v0902026-07-14-beta-发布)
  - [2.17 v0.5.0（2026-06-30）Alpha 发布](#217-v0502026-06-30-alpha-发布)
  - [2.18 v0.1.0（2026-06-01）初始原型](#218-v0102026-06-01初始原型)
  - [2.19 v1.0.1（2026-07-21）一致性修订与部署章节下线](#219-v1012026-07-21一致性修订与部署章节下线)
- [3. 文档变更记录](#3-文档变更记录)
...
### 2.1 v1.2.3（2026-08-14）MessageList Tests
...
### 2.2 v1.2.2（2026-08-14）MessageBubble Content Block Coverage
...
### 2.3 v1.2.1（2026-08-14）ModelPicker Real-Component Tests
...
### 2.4 v1.2.0（2026-08-14）Web Component Test Expansion
...
### 2.5 v1.1.9（2026-08-14）Release Engineering & Web Component Tests
...
### 2.6 v1.1.8（2026-08-13）CLI Memory Management
...
### 2.7 v1.1.7（2026-08-13）Web Memory Management UI
...
### 2.8 v1.1.6（2026-08-13）Memory API & Release Engineering
...
### 2.9 v1.1.5（2026-08-13）Memory Test Coverage & Doctor JSON
...
### 2.10 v1.1.4（2026-08-13）System Overview & Diagnostics
...
### 2.11 v1.1.3（2026-08-12）CI 绿 + lint 清理
...
### 2.12 v1.1.1（2026-07-24）Channels 渠道模块正式实现
...
### 2.13 v1.0.2（2026-07-23）文档同步代码实际状态
...
### 2.16 v0.9.0（2026-07-14）Beta 发布
...
### 2.17 v0.5.0（2026-06-30）Alpha 发布
...
### 2.19 v1.0.1（2026-07-21）一致性修订与部署章节下线
