...
- [1. 变更记录说明](#1-变更记录说明)
  ...
  - [1.3 记录规范](#13-记录规范)
- [2. 变更记录表](#2-变更记录表)
  - [2.1 v1.1.5（2026-08-13）Memory Test Coverage & Doctor JSON](#21-v1152026-08-13memory-test-coverage--doctor-json)
  - [2.2 v1.1.4（2026-08-13）System Overview & Diagnostics](#22-v1142026-08-13system-overview--diagnostics)
  - [2.3 v1.1.3（2026-08-12）CI 绿 + lint 清理](#23-v1132026-08-12ci-绿--lint-清理)
  - [2.4 v1.1.1（2026-07-24）Channels 渠道模块正式实现](#24-v1112026-07-24channels-渠道模块正式实现)
  - [2.5 v1.0.2（2026-07-23）文档同步代码实际状态](#25-v1022026-07-23文档同步代码实际状态)
  - [2.6 v1.1.0（2026-07-21）客户端层新增](#26-v1102026-07-21客户端层新增)
  - [2.7 v1.0.0（2026-07-21）首次正式发布](#27-v1002026-07-21首次正式发布)
  - [2.8 v0.9.0（2026-07-14）Beta 发布](#28-v0902026-07-14-beta-发布)
  - [2.9 v0.5.0（2026-06-30）Alpha 发布](#29-v0502026-06-30-alpha-发布)
  - [2.10 v0.1.0（2026-06-01）初始原型](#210-v0102026-06-01初始原型)
  - [2.11 v1.0.1（2026-07-21）一致性修订与部署章节下线](#211-v1012026-07-21一致性修订与部署章节下线)
- [3. 文档变更记录](#3-文档变更记录)
...
### 2.1 v1.1.5（2026-08-13）Memory Test Coverage & Doctor JSON
...
### 2.2 v1.1.4（2026-08-13）System Overview & Diagnostics
...
### 2.3 v1.1.3（2026-08-12）CI 绿 + lint 清理
...
### 2.4 v1.1.1（2026-07-24）Channels 渠道模块正式实现
...
### 2.5 v1.0.2（2026-07-23）文档同步代码实际状态
...
### 2.9 v0.5.0（2026-06-30）Alpha 发布
...
### 2.11 v1.0.1（2026-07-21）一致性修订与部署章节下线
