...
- [1. 变更记录说明](#1-变更记录说明)
  ...
  - [1.3 记录规范](#13-记录规范)
- [2. 变更记录表](#2-变更记录表)
  - [2.1 v1.1.0（2026-07-21）客户端层新增](#21-v1102026-07-21客户端层新增)
- [2.2 v1.0.0（2026-07-21）首次正式发布](#22-v1002026-07-21首次正式发布)
- [2.3 v0.9.0（2026-07-14）Beta 发布](#23-v0902026-07-14-beta-发布)
- [2.4 v0.5.0（2026-06-30）Alpha 发布](#24-v0502026-06-30-alpha-发布)
- [2.5 v0.1.0（2026-06-01）初始原型](#25-v0102026-06-01初始原型)
- [2.6 v1.0.1（2026-07-21）一致性修订与部署章节下线](#26-v1012026-07-21一致性修订与部署章节下线)
- [3. 文档变更记录](#3-文档变更记录)
...
- 新增 Telegram 渠道适配器，支持文本、图片、命令消息（`channels/telegram/`）
- 新增 Discord 渠道适配器，支持文本、嵌入、斜杠命令（`channels/discord/`）
...
- 新增渠道接入配置示例模板（Telegram/Discord/飞书/WebChat）
- 新增 LICENSE（MIT 协议）
...
- 修复 Telegram 适配器在长轮询模式下偶发的超时崩溃问题（#45）
...
- 新增 Telegram 渠道适配器（`channels/telegram/`）
- 新增 Discord 渠道适配器（`channels/discord/`）
...
### 2.6 v1.0.1（2026-07-21）一致性修订与部署章节下线
