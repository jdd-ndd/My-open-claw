...
- [1. 变更记录说明](#1-变更记录说明)
  ...
  - [1.3 记录规范](#13-记录规范)
- [2. 变更记录表](#2-变更记录表)
  - [2.1 v1.1.8（2026-08-13）CLI Memory Management](#21-v1182026-08-13cli-memory-management)
  - [2.2 v1.1.7（2026-08-13）Web Memory Management UI](#22-v1172026-08-13web-memory-management-ui)
  - [2.3 v1.1.6（2026-08-13）Memory API & Release Engineering](#23-v1162026-08-13memory-api--release-engineering)
  - [2.4 v1.1.5（2026-08-13）Memory Test Coverage & Doctor JSON](#24-v1152026-08-13memory-test-coverage--doctor-json)
  - [2.5 v1.1.4（2026-08-13）System Overview & Diagnostics](#25-v1142026-08-13system-overview--diagnostics)
  - [2.6 v1.1.3（2026-08-12）CI 绿 + lint 清理](#26-v1132026-08-12ci-绿--lint-清理)
  - [2.7 v1.1.1（2026-07-24）Channels 渠道模块正式实现](#27-v1112026-07-24channels-渠道模块正式实现)
  - [2.8 v1.0.2（2026-07-23）文档同步代码实际状态](#28-v1022026-07-23文档同步代码实际状态)
  - [2.9 v1.1.0（2026-07-21）客户端层新增](#29-v1102026-07-21客户端层新增)
  - [2.10 v1.0.0（2026-07-21）首次正式发布](#210-v1002026-07-21首次正式发布)
  - [2.11 v0.9.0（2026-07-14）Beta 发布](#211-v0902026-07-14-beta-发布)
  - [2.12 v0.5.0（2026-06-30）Alpha 发布](#212-v0502026-06-30-alpha-发布)
  - [2.13 v0.1.0（2026-06-01）初始原型](#213-v0102026-06-01初始原型)
  - [2.14 v1.0.1（2026-07-21）一致性修订与部署章节下线](#214-v1012026-07-21一致性修订与部署章节下线)
- [3. 文档变更记录](#3-文档变更记录)
...
### 2.1 v1.1.8（2026-08-13）CLI Memory Management
...
### 2.2 v1.1.7（2026-08-13）Web Memory Management UI
...
### 2.3 v1.1.6（2026-08-13）Memory API & Release Engineering
...
### 2.4 v1.1.5（2026-08-13）Memory Test Coverage & Doctor JSON
...
### 2.5 v1.1.4（2026-08-13）System Overview & Diagnostics
...
### 2.6 v1.1.3（2026-08-12）CI 绿 + lint 清理
...
### 2.7 v1.1.1（2026-07-24）Channels 渠道模块正式实现
...
### 2.8 v1.0.2（2026-07-23）文档同步代码实际状态
...
### 2.11 v0.9.0（2026-07-14）Beta 发布
...
### 2.12 v0.5.0（2026-06-30）Alpha 发布
...
### 2.14 v1.0.1（2026-07-21）一致性修订与部署章节下线
